...
const demo = document.querySelectorAll(".projectButton");

demo[0].onclick = function () {
  location.href = "https://isocial.onrender.com";
};
demo[1].onclick = function () {
  location.href = "https://web3-game.netlify.app/";
};
demo[2].onclick = function () {
  location.href = "https://chat-web3-27sh.vercel.app/";
};
document.querySelector(".githubChart").onclick = function () {
  location.href = "https://github.com/maadi7";
};
...
window.addEventListener("scroll", () => {
  ...
  authorName.style.transform = `translateX(calc(-20vh + ${offsetY * 0.3}px))`;
  ...
  laptop[2].style.transform = `translateX(calc(745vh - ${offsetY}px))`;
});
